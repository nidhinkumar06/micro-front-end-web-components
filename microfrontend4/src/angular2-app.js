...
window.customElements.define('angular2-app', class AngularApp extends HTMLElement {
    ...
    constructor(self) {
        ...
        console.log('Angular2App constructor', this);
    ...
    connectedCallback() {
        ...
        console.log('Angular2App connected');
        ...
        angular.module(name, [AppModule])
            ...
            .run(() => {
                console.log(`Angular2 module ${AppModule} instance is running`);
    ...
    disconnectedCallback() {
        console.log('Angular2App disconnected');
    }

    attributeChangedCallback(attrName, oldVal, newVal) {
        console.log('Angular2App attributeChanged', attrName, oldVal, newVal);
